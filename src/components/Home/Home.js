  ...
  const imagesBanner = [
    {
      ...
      describe: 'Descubre los mejores consejos y técnicas para mantener el pelaje de tu mascota saludable y brillante.',
    },
    {
      imageUrl: alimentoMascota,
      title: 'ALIMENTACIÓN SALUDABLE',
      describe: 'Explora recetas y consejos para una dieta equilibrada que mantenga a tu mascota feliz y saludable.',
    },
    {
    ...
    },
    {
      ...
      describe: 'Descubre los mejores juegos y actividades para mantener a tu mascota activa, feliz y en forma.',
    },
  ];
  ...
  const items = [
    {
      image: mia,
      title: 'MIA',
      text: '¡Increíble descubrimiento! Encontré un lugar para bañar a mi gata con facilidad. ¡Ahora luce impecable y feliz!',
    },
    {
      image: roko,
      title: 'ROKO',
      text: '¡Pawsly simplificó mi vida! Encontré un veterinario cerca en un abrir y cerrar de ojos. ¡Recomendado al 100%!',
    },
    {
      image: luna,
      title: 'LUNA',
      text: '¡Pawsly es genial! Encontré una tienda de mascotas cercana para comprar juguetes nuevos para mi cachorro. ¡Ahora juega sin parar!',
    },
    {
      image: simon,
      title: 'SIMÓN',
      text: '¡Pawsly es increíble! Encontré un spa para mi gato en minutos. ¡Ahora luce tan elegante como un rey felino!',
    },
    {
      image: max,
      title: 'MAX',
      text: '¡Excelente servicio! Encontré una guardería para mi perro rápidamente. ¡Mi amigo peludo está feliz y yo también!',
    },
  ];
