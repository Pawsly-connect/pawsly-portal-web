...
const Banner = ({ title, text, button='', buttonPosition="center", titlePosition="left", handleClick=()=>{}, verticalAlign="flex-start" }) => {
    ...
    return (
        <BannerContainer className={styles.banner} $verticalAlign={verticalAlign}>
            ...
            {hasButton && (
                <ButtonContainer $buttonPosition={buttonPosition === 'left' ? 'flex-start' : buttonPosition === 'right' ? 'flex-end' : 'center'}>
